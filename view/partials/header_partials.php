...
<head>
	...
	<meta property="og:url" content="https://jorgedipra.com" />
	...
	<link rel="apple-touch-icon" href="./storage/logo/h1.jpg" />
	<link rel="canonical" href="https://jorgedipra.com" />

	<link rel="stylesheet" href="public/css/font/roboto/roboto.css">
	<link rel="stylesheet" href="<?=host('css','style')?>">
	<link rel="stylesheet" href="public/css/<?=$match['name']?>.css?v=0.2.1">
	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-115887326-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	  gtag('config', 'UA-115887326-1');
	</script>
	<script>
var _rollbarConfig = {
    accessToken: "5679f108978b47afa79cd03ebb27b579",
