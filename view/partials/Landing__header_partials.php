	...
	<nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			...
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link " href="#"><i class="fab fas fa-tv fab-2x"></i>Portafolio</a>
				</li>
				<li class="nav-item">
					<a class="nav-link " href="#"><i class="fab fas fa-link fab-2x"></i>Savelink</a>
				</li>
				<li class="nav-item">
					<a class="nav-link " href="#"><i class="fab fas fa-envelope fab-2x"></i>Contactame</a>
				</li>
			</ul>
